...
@Controller
public class CarSpringMVCController
{
    @Autowired
    private CarService carService;

    private static final Logger logger = LoggerFactory.getLogger(CarSpringMVCController.class);
    ...
    public Car deleteCar(@RequestBody String id)
    {
